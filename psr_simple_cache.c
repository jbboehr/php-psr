...
PHPAPI zend_class_entry * PsrSimpleCacheCacheException_ce_ptr;
...
PHPAPI zend_class_entry * PsrSimpleCacheCacheInterface_ce_ptr;
...
PHPAPI zend_class_entry * PsrSimpleCacheInvalidArgumentException_ce_ptr;
