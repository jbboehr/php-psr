...
let
  packages = {
    ...
    "psr/container" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "psr-container-2ae37329ee82f91efadc282cc2d527fd6065a5ef";
        src = fetchurl {
          url = "https://api.github.com/repos/php-fig/container/zipball/2ae37329ee82f91efadc282cc2d527fd6065a5ef";
          sha256 = "0cba4lgrph04ij8lg9bqwfwpq0s522w2v327i575j1ha9j8i2jb6";
        };
      };
    };
  };
  devPackages = {
    ...
    "psx/cache" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "psx-cache-db251e891d553b5fb633c5f2535a36bfcdfa52cf";
        src = fetchurl {
          url = "https://api.github.com/repos/apioo/psx-cache/zipball/db251e891d553b5fb633c5f2535a36bfcdfa52cf";
          sha256 = "1x6dz7glxjjxkgvq3kdzqc6dy55278diisv3f474xiyjsi9svp24";
        };
      };
    };
