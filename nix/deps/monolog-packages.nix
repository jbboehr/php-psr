...
let
  ...
  devPackages = {
    "aws/aws-sdk-php" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "aws-aws-sdk-php-45692b97e12a2eed540c0afd106f143aad15e622";
        src = fetchurl {
          url = "https://api.github.com/repos/aws/aws-sdk-php/zipball/45692b97e12a2eed540c0afd106f143aad15e622";
          sha256 = "0qkmf57c5dba27w5lfp36w7p207v4pbx09p5jfd2ix1xdh38if2l";
        };
      };
    };
    "doctrine/couchdb" = {
    ...
    "php-parallel-lint/php-parallel-lint" = {
      targetDir = "";
      src = composerEnv.buildZipPackage {
        name = "php-parallel-lint-php-parallel-lint-772a954e5f119f6f5871d015b23eabed8cbdadfb";
        src = fetchurl {
          url = "https://api.github.com/repos/php-parallel-lint/PHP-Parallel-Lint/zipball/772a954e5f119f6f5871d015b23eabed8cbdadfb";
          sha256 = "0dcr16jnbdk7djsd94aiblfhd5gr6rzznzasmxwaf9hgwxh2i9kj";
        };
      };
    };
