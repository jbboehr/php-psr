...
PHP_ARG_ENABLE(psr-coverage, whether to enable psr coverage support,
[AS_HELP_STRING([--enable-psr-coverage], [Enable psr coverage support])], [no], [no])
...
#/**/undef/**/ HAVE_ASM_GOTO
    ...
    if test "$PHP_PSR_COVERAGE" == "yes"; then
